package com.thirdgear.example.erp_api_demo.core.constants;
...
public class MessagingConstants {
	 ...
	 */
		...
		/** When composition changes for a given tank, requests are placed onto this que. There should 
	 ...
	 */
		...
		/** Clients that need realtime notification of when com calculation is complete 
